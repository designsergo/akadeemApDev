...
function ak_scripts_styles() {
	...
	wp_enqueue_script('akadeemia-js', get_template_directory_uri().'/js/akadeemia.min.js', array('jquery-mobile-js'), md5_file(get_template_directory_uri().'/js/akadeemia.min.js'), true);
}
...
function ak_add_footer_styles() {
	...
	wp_enqueue_style('akadeemia', get_template_directory_uri().'/css/akadeemia.min.css', array(), md5_file(get_template_directory_uri().'/css/akadeemia.min.css'));
};
